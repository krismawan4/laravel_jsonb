...
use App\Models\MasterTableValidation;
use App\Traits\SendResponse;
use Illuminate\Http\Request;

class MasterTableValidationController extends Controller
{
    use SendResponse;

    public function index()
    {
        $data = MasterTableValidation::orderBy('id', 'asc')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = MasterTableValidation::create($validated);
    ...
    {
        $data = MasterTableValidation::find($id);
        if (! $data) {
